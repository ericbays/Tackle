...
export default function WorkspaceLayout() {
    ...
    const { fetchCampaign, isLoading } = useCampaignStore();
        ...
        <div className="max-w-7xl mx-auto space-y-6">
            ...
            <div className="space-y-4">
                <div className="flex items-center text-sm font-medium text-slate-400">
                    ...
                    <span className="text-slate-200">Campaign {id}</span>
                </div>

                <div className="flex items-start justify-between">
                    <div>
                        <div className="flex items-center gap-3">
                            <h1 className="text-3xl font-bold text-white tracking-tight">Campaign {id}</h1>
                            <span className="bg-slate-700 text-slate-200 text-xs uppercase tracking-widest font-semibold px-2.5 py-1 rounded-md">Draft</span>
                        </div>
                        ...
                        <p className="text-xs text-slate-500 mt-3">Created today by Administrator · Last edited just now</p>
                    </div>
                </div>
            </div>
