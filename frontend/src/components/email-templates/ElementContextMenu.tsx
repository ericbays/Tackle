        ...
        return (
            <div className="space-y-3 pb-2">
                <div className="flex bg-slate-900 border border-slate-700 rounded overflow-hidden">
                    <Button variant="outline" onClick={ () => applyStyle(targetNode, 'text-align', 'left')} className="flex-1 py-1 hover:bg-slate-700 hover:text-white text-slate-400 flex justify-center"><AlignLeft className="w-3.5 h-3.5" /></Button>
                    <Button variant="outline" onClick={ () => applyStyle(targetNode, 'text-align', 'center')} className="flex-1 py-1 hover:bg-slate-700 hover:text-white text-slate-400 flex justify-center border-l border-r border-slate-700"><AlignCenter className="w-3.5 h-3.5" /></Button>
                    <Button variant="outline" onClick={ () => applyStyle(targetNode, 'text-align', 'right')} className="flex-1 py-1 hover:bg-slate-700 hover:text-white text-slate-400 flex justify-center border-r border-slate-700"><AlignRight className="w-3.5 h-3.5" /></Button>
                    <Button variant="outline" onClick={ () => applyStyle(targetNode, 'text-align', 'justify')} className="flex-1 py-1 hover:bg-slate-700 hover:text-white text-slate-400 flex justify-center"><AlignJustify className="w-3.5 h-3.5" /></Button>
                </div>
